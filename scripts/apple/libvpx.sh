...
armv7 | armv7s)
  ...
  ASM_OPTIONS="--disable-runtime-cpu-detect --enable-neon --enable-neon-asm --disable-neon-i8mm"
  ;;
arm64*)
  ...
  #    vst1.64
  ASM_OPTIONS="--disable-runtime-cpu-detect --enable-neon --disable-neon-i8mm"
  ;;
i386)
